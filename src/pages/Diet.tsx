      ...
      <Modal open={open} onClose={handleClose}>
        <Box sx={style}>
          ...
          <FormControlLabel
            control={
              <Checkbox
                checked={dietForm.fruit}
                name="fruit"
                onChange={handleChange}
                size="small"
              />
            }
            label={<Typography>fruit</Typography>}
          />

          <FormControlLabel
            control={
              <Checkbox
                checked={dietForm.nachos}
                name="nachos"
                onChange={handleChange}
                size="small"
              />
            }
            label={<Typography>nachos</Typography>}
          />

          <FormControlLabel
            control={
              <Checkbox
                checked={dietForm.breyani}
                name="breyani"
                onChange={handleChange}
                size="small"
              />
            }
            label={<Typography>breyani</Typography>}
          />

          <FormControlLabel
            control={
              <Checkbox
                checked={dietForm.pasta}
                name="pasta"
                onChange={handleChange}
                size="small"
              />
            }
            label={<Typography>pasta</Typography>}
          />

          <FormControlLabel
            control={
              <Checkbox
                checked={dietForm.medication}
                name="medication"
                onChange={handleChange}
                size="small"
              />
          ...
          <FormControlLabel
            control={
              <Checkbox
                checked={dietForm.pastry}
                name="pastry"
                onChange={handleChange}
                size="small"
              />
            }
            label={<Typography>pastry</Typography>}
          />
